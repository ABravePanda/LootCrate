...
public enum Message {
    ...
    LOOTCRATE_COMMAND_UNSET_USAGE("lootcrate-command-unset-usage"),
    LOOTCRATE_COMMAND_UNSET_SUCCESS("lootcrate-command-unset-success"),
    LOOTCRATE_COMMAND_UNSET_FAILURE("lootcrate-command-unset-failure"),
